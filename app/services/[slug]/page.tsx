...
export default async function ServiceDetailPage({
  ...
  return (
    <div className="pt-28 md:pt-40 min-h-screen text-slate-800 bg-slate-50/50 font-shippori">
      <main className="py-10 sm:py-14 md:py-24 lg:pt-50 w-full min-h-screen font-shippori">
        <article className="w-full max-w-[1060px] mx-auto px-4 sm:px-6 md:px-10">
          ...
          <div className="space-y-16 sm:space-y-24 md:space-y-32">
            ...
            <section>
              ...
              {/* merit cards: 1col → 2col(sm) → 3col(md) */}
            ...
            {service.detail && service.detail.length > 0 && (
              <section>
                ...
                {/* detail cards: 1col(mobile) → 2col(sm+) */}
            ...
            <section className="pb-4">
              ...
              {/* service links: 1col(mobile) → 2col(sm+) */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
