...
export default function Contact() {
  return (
    <div className="pt-28 md:pt-40 min-h-screen text-slate-800 bg-slate-50/50 font-shippori leading-relaxed space-y-4">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-20 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.08)] border border-white text-center">
            ...
            <div className="flex justify-center">
              <a
                ...
                className="flex items-center gap-4 bg-blue-600 text-white px-10 py-5 rounded-full font-bold text-sm md:text-lg hover:bg-gray-950 transition-all duration-300 shadow-lg shadow-blue-200"
              >
