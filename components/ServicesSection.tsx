        ...
        {SERVICES.map((service: Service, index: number) => (
          ...
          >
            <div className="w-full md:w-1/3">
              <div className="relative aspect-[16/9] md:aspect-[4/3] w-full overflow-hidden rounded-4xl">
                {" "}
                <Image
                  src={service.image}
                  alt={service.title}
            ...
            <div className="w-full md:w-1/2">
              <h2 className=" font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl mb-4 md:mb-6 border-b-2 border-gray-100 pb-2">
                {service.title}
              </h2>
