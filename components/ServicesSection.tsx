...
export default function ServicesSection() {
  return (
    <section className="py-5 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-12 md:gap-16 lg:gap-20">
        {SERVICES.map((service: Service, index: number) => (
          <div
            key={service.slug}
            className={`flex flex-col md:flex-row ${index % 2 === 1 ? 'md:flex-row-reverse' : ''} items-center gap-6 md:gap-10 lg:gap-16`}
          >
            <div className="w-full md:w-1/2 lg:w-5/12 max-w-md mx-auto">
